...
namespace GameInv_WPF.Dialogs {
    public partial class TickTimeDialog {
        private readonly GameInv.GameInv _gameInv;
        private int _tickCount;

        public TickTimeDialog(GameInv.GameInv gameInv) {
            InitializeComponent();

            _gameInv = gameInv;

            AutoSelectTextBoxOnRender(TickAmountNumberBox, this);
        }
